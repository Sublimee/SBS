...
# Есть магазин, который хочет фиксировать заказанные товары. У магазина есть склад, на котором есть определенное
# количество каждого товара. Каждый заказ приводит к тому, что количество товаров на складе уменьшается, а список
# заказанных позиций расширяется.
