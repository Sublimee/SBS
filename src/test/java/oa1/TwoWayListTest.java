...
import oa1.two_way_list.TwoWayList;
...
public class TwoWayListTest {
    ...
    private TwoWayList<Integer> list;
    ...
    @Test
    public void testErrorLeft() {
        list.add_tail(1);
        list.left();

        assertEquals(list.get_left_status(), list.LEFT_ERR);
    }

    @Test
    public void testOkLeft() {
        list.add_tail(1);
        list.add_tail(2);
        list.add_tail(3);
        list.tail();
        ...
        assertEquals(2, list.get().intValue());
        assertEquals(list.get_left_status(), list.LEFT_OK);
    }
}