 ...
 * быть массив. При переполнении при суммировании очередного разряда (сумма больше 9) должен быть осуществлен перенос
 * в старший разряд. Результат может содержать лидирующие нули, слагаемые -- нет. Слагаемые содержат хотя бы 1 разряд.
 */
