...
import some.company.exceptions.InternalException
import some.company.loyalty.promoted.cashback.configuration.ProgramsProperties.Companion.CATEGORICAL_CASHBACK_PROGRAM_ID
import some.company.loyalty.promoted.cashback.configuration.SummaryProperties
import some.company.loyalty.promoted.cashback.exception.LogicErrorCode
import some.company.loyalty.promoted.cashback.model.Button
import some.company.loyalty.promoted.cashback.model.CategoricalCashbackSummaryResponse
import some.company.loyalty.promoted.cashback.model.CategoriesSection
import some.company.loyalty.promoted.cashback.model.CategoryRepresentation
import some.company.loyalty.promoted.cashback.service.client.model.Category
import some.company.loyalty.promoted.cashback.service.client.model.ConfirmedCategories
import some.company.loyalty.promoted.cashback.service.client.model.SuggestedCategories
import some.company.loyalty.promoted.cashback.service.proxy.CategoriesProviderService
import some.company.loyalty.promoted.cashback.service.proxy.CommonProviderService
import some.company.loyalty.promoted.cashback.util.CategoriesSectionUtils.validateAndFixSuggestedCategoriesSection
import some.company.loyalty.promoted.cashback.util.DateTimeUtils.getPrepositionalMonthName
import some.company.loyalty.promoted.cashback.util.DeclensionUtils.getCategoryDeclensionInAccusativeCase
import some.company.loyalty.promoted.cashback.util.DeclensionUtils.getCategoryDeclensionInNominativeCase
import some.company.loyalty.promoted.cashback.util.DeclensionUtils.toAccusativeCase
